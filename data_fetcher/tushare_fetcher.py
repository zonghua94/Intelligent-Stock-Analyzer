...
class TushareFetcher(BaseFetcher):
    ...
    def __init__(self, args: FetcherArgs, rate_limit_per_minute: int = 80):
        """
        初始化 TushareFetcher
    ...
    def _init_api(self) -> None:
        ...
        if not self.args.tushare_token:
        ...
        try:
            ...
            # Set Token
            ts.set_token(self.args.tushare_token)
            ...
            self._patch_api_endpoint(self.args.tushare_token)
    ...
    def _determine_priority(self) -> int:
        ...
        """
        if self.args.tushare_token and self._api is not None:
